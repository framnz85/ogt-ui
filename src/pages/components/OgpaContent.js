...
const OgpaContent = ({
    ...
    return (
        <div style={{marginTop: 20, fontSize: isMobile ? 16 : 20}}>            
            ...
            So I will <span style={{color: "blue"}}>bring down the enrollment fee from 56,990 to only P36,990 (pay 3 months installment)</span> but only for this schedule.
            <br /><br />

            Yes! For only <b style={{color: "green"}}>P36,990</b> you will get the Grocery <u>eCommerce Website</u> which includes a <u>Domain Name</u> so you can brand your business, a <u>Mobile App</u>,
            the <u>5 Workshop Lessons</u>, the copying of grocery items, and the 3 bonuses.
            <br /><br />

            <h4 style={{color: "red"}}>That's P20,000 less! </h4>
            <br />
